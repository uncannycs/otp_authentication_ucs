...

{
    ...
    'summary': 'Secure OTP & Email Authentication / Two-Factor Authentication (2FA) for Odoo 19',
    'description': """
OTP & Email Authentication
================================

Adds secure Email-based One-Time Password (OTP) verification to the Odoo 19 login pipeline.

document.addEventListener("DOMContentLoaded", function () {
    ...
    carousels.forEach(carousel => {
        ...
        const indicators = carousel.querySelectorAll('.carousel-indicators button, .carousel-indicators div, [data-bs-slide-to], [data-slide-to]');
        const prevBtns = carousel.querySelectorAll('.carousel-control-prev, [data-bs-slide="prev"], [data-slide="prev"]');
        const nextBtns = carousel.querySelectorAll('.carousel-control-next, [data-bs-slide="next"], [data-slide="next"]');
        let currentIndex = 0;
        let cycleInterval;
